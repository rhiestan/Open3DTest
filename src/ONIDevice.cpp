...
void ONIDevice::setConverter(ONI3DConverter *pConverter)
{
	if(pDepthListener_ != NULL)
		pDepthListener_->setConverter(pConverter);
	if(pColorListener_ != NULL)
		pColorListener_->setConverter(pConverter);
}
